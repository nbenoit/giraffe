...
/**
 * Class GateOr : defines the OR Gate
 */
public class GateOr extends GateTwoInputs
{
    /**
     ...
     */
    public GateOr ( Wire i1, Wire i2, Wire o )
    {
        super ( i1, i2, o );
        this.setDelay ( 1 );
    }
